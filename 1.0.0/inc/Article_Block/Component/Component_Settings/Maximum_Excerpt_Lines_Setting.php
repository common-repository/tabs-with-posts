...
/**
 * Class used to change the maximum lines of excerpt variable of the specific
 * component.
 */
class Maximum_Excerpt_Lines_Setting extends Component_Setting {

	public function get_key_name() {
		return 'maximum_lines_of_excerpt';
	}
	...
	protected function get_control_setting_args() {
		return array(
			'default' => '',
			'before'  => _x( 'Lines of excerpt(maximum):', 'backend', 'tabs-with-posts' ),
			'after'   => '',
			'max'     => '7',
			'min'     => '3',
			'step'    => '1',
	...
	public function get_css( $value ) {
		if ( is_numeric( $value ) ) {
			return "--twrp-excerpt-max-lines-shown:${value};";
		}
