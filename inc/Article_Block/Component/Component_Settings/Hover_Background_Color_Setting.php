...
/**
 * Class used to change the hover background color of the specific component.
 */
class Hover_Background_Color_Setting extends Component_Setting {
	...
	protected function get_control_setting_args() {
		return array(
			'default' => '',
			'before'  => _x( 'Background color - mouse over:', 'backend', 'tabs-with-posts' ),
		);
	}
